...
export default function Home() {
  const eventos = [
    ...
    },
    {
      ...
      imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-r5ou95M6xf_AIZL_6JP9bKFsT453PwekgA&s",
      fecha: "2024-03-15",
    },
    {
    ...
    },
    {
      ...
      imagen: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRW1k3rG6XMDqBuQFDHfhPgYWK6jPQNCT2MSg&s",
      fecha: "2024-05-20",
    },
    {
      nombre: "Museo Bellas Artes",
      imagen: "https://turismo.buenosaires.gob.ar/sites/turismo/files/museo-nacional-bellas-artes-1500x610-interior.jpg",
      fecha: "2024-06-05",
    },
    {
  ...
  return (
    <div className={styles.container}>
      {
        eventos.map((e)=><CardEvento evento={e}></CardEvento>)
      }
    </div>
  );
}
